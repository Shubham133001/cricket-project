...
export default {
  ...
  methods: {
          ...
          await axios
            ...
            .then((response) => {
              if (response.data.success) {
                this.$toasted.success("Sub Category deleted successfully", {
                  duration: 2000,
                });
                this.getcategories();
              }
    ...
    getcategories() {
      axios
        .post("/api/admin/category/getsubcategories", {
        ...
        .then((response) => {
          ...
          categories.forEach((category) => {
            ...
            category.show = false;
            category.image =
              category.image != null ? category.image.split(",") : "";
    ...
    addslot(item) {
      axios
        .post("/api/admin/category/changetype", {
          type: "slot",
          id: item.id,
        })
        .then((response) => {
