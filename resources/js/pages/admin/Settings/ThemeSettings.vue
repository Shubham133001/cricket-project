                    ...
                    <v-expansion-panels accordion class="mt-4">
                        <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                                <v-file-input v-model="banner.background" accept="image/*" label="Select Image" prepend-icon="mdi-camera" @change="onBannerbgChange"></v-file-input>
                                <v-checkbox v-model="banner.backgroundshow" label="Show (Tick to show)" prepend-icon="mdi-eye" value="true"></v-checkbox>
                         ...
                         <v-expansion-panel >
                            ...
                            <v-expansion-panel-content>
                                <v-file-input v-model="banner.image" accept="image/*" label="Select Image" prepend-icon="mdi-camera" @change="onBannerimgchnage"></v-file-input>
                                <v-checkbox v-model="banner.imageshow" label="Show (Tick to show)" prepend-icon="mdi-eye" value="true"></v-checkbox>
                                <v-img :src="newimage" class="mx-auto" height="300" max-width="500" style="margin: auto;"></v-img>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                       <v-expansion-panel>
                            <v-expansion-panel-header>Hero Title</v-expansion-panel-header>
                            <v-expansion-panel-content>
                                <v-text-field v-model="banner.title" label="Banner Title"></v-text-field>
                                <v-row>
                                    <v-col cols="12" md="4">
                                        <p>Banner Title Color</p>
                                        <v-color-picker v-model="banner.titlecolor" label="Banner Title Color"></v-color-picker>
                                    </v-col>
                                    <v-col cols="12" md="4">
                                        <p>Banner Title Font Size</p>
                                        <v-text-field v-model="banner.titlesize" label="Banner Title Font Size"></v-text-field>
                                    </v-col>
                                </v-row>
                         ...
                         <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                                <v-text-field v-model="banner.subtitle" label="Banner Subtitle"></v-text-field>
                                <v-row>
                                    <v-col cols="12" md="4">
                                        <p>Banner Subtitle Color</p>
                                        <v-color-picker v-model="banner.subtitlecolor" label="Banner Subtitle Color"></v-color-picker>
                                    </v-col>
                                    <v-col cols="12" md="4">
                                        <p>Banner Subtitle Font Size</p>
                                        <v-text-field v-model="banner.subtitlesize" label="Banner Subtitle Font Size"></v-text-field>
                                    </v-col>
                                </v-row>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                       <v-expansion-panel>
                            ...
                            <v-expansion-panel-content>
                                ...
                                <v-color-picker v-model="banner.btntextcolor" label="Banner Button Text Color"></v-color-picker>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                         <!-- <v-expansion-panel>
                            <v-expansion-panel-header>Partners</v-expansion-panel-header>
                            <v-expansion-panel-content>
                                <v-file-input accept="image/*" multiple label="Select Image" prepend-icon="mdi-camera" @change="onPartnerschange"></v-file-input>
                                <v-checkbox v-model="showpartners" label="Show (Tick to show)" prepend-icon="mdi-eye" value="true"></v-checkbox>
                                <v-row>
                                    <v-col v-for="(partner, index) in partnerimages" :key="index" cols="12" md="2">
                                        <v-img :src="partner" class="mx-auto" height="110" max-width="500" style="margin: auto;"></v-img>
                                    </v-col>
                                </v-row>
                            </v-expansion-panel-content>
                        </v-expansion-panel> -->
                        <v-expansion-panel >
                            ...
                            <v-expansion-panel-content>
                                <vue-editor v-model="aboutexcerpts" outlined label="About Excerpts" persistent-hint clearable rows="4" cols="40"></vue-editor>
                                <v-checkbox v-model="showabout" label="Show (Tick to show)" prepend-icon="mdi-eye" value="true"></v-checkbox>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                       <v-expansion-panel >
                            ...
                            <v-expansion-panel-content>
                                <p>Why us Image</p>
                                <v-file-input accept="image/*" label="Select Image" prepend-icon="mdi-camera" @change="onwhyusimagechange"></v-file-input>
                                <v-img :src="newwhyusimage" class="mx-auto" height="500" max-width="440" style="margin: auto;"></v-img>
                                <v-checkbox v-model="showwhyus" label="Show (Tick to show)" prepend-icon="mdi-eye" value="true"></v-checkbox>
                                <v-row>
                                    <v-col cols="12" md="12" v-for="feature,index in whyusfeatures" :key="index">
                                        ...
                                        <v-text-field v-model="feature.description" label="Feature Subtitle"></v-text-field>
                                        <v-btn color="error" class="mt-2 mb-2 float-right" @click="removefeature(index)">Remove Feature</v-btn>
                                    </v-col>
                                    <v-btn color="primary" class="mt-2 mb-2 float-right" @click="addfeature">Add Feature</v-btn>
                                </v-row>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                        <v-expansion-panel >
                            ...
                            <v-expansion-panel-content>
                                ...
                                <v-row>
                                    <v-col cols="12" md="12" v-for="feature,index in features" :key="index">
                                        <v-autocomplete v-model="feature.icon" :items="icons" item-text="name" item-value="name" label="Icon"></v-autocomplete>
                                        <v-text-field v-model="feature.title" label="Feature Title"></v-text-field>
                                        <v-text-field v-model="feature.description" label="Feature Subtitle"></v-text-field>
                                        <v-btn color="error" class="mt-2 mb-2 float-right" @click="removefeaturesfeature(index)">Remove Feature</v-btn>
                                    </v-col>
                                </v-row>
                                <v-btn color="primary" class="mt-2 mb-2 float-right" @click="addfeaturesfeature">Add Feature</v-btn>
                            </v-expansion-panel-content>
                        </v-expansion-panel>
                        <v-expansion-panel >
                            ...
                            <v-expansion-panel-content>
                                ...
                                <v-row>
                                    <v-col cols="12" md="12" v-for="faq,index in faqs" :key="index">
                                        ...
                                        <v-btn color="error" class="mt-2 mb-2 float-right" @click="removefaq(index)">Remove Faq</v-btn>
                                    </v-col>
                                </v-row>
    ...
    export default {
        ...
        data() {
            return {
                //
                icons: Icons,
                // activetheme: localStorage.getItem("store") == undefined ||
                //     localStorage.getItem("store") == null ?
                //     "default" :
                //     ((JSON.parse(JSON.parse(localStorage.getItem("store")).themesettings).themename != undefined) ? JSON.parse(JSON.parse(localStorage.getItem("store")).themesettings).themename : 'default'),
               ...
               //  showpartners: 'false',
                ...
                showwhyus: 'false',
                featureheading: 'Take your online security to the next level',
                features: [{
        ...
        methods: {
            ...
            onPartnerschange(e) {
                ...
                for (let index = 0; index < files.length; index++) {
                    this.partners.push(files[index]);
            ...
            save() {
               ...
               // formData.append('showpartners', (this.showpartners != 'undefined' || this.showpartners != null) ? this.showpartners : 'false');
                ...
                formData.append('featureheading', this.featureheading);
                ...
                //     formData.append('partners[]', partner);
                // });
                // formData.append('partners[]', this.partners);
            ...
            getthemeoptions() {
                var self = this;
                axios.get('/api/admin/getpageoption')
                    .then(function(response) {
