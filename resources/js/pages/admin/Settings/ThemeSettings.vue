    ...
    data() {
        return {
            ...
            banner: {
                ...
                title: '<p>&lt;h1 class="text-h4 text-sm-h3 text-md-h3 text-lg-h2"&gt;Digitize your sports venue with &lt;br /&gt;&lt;span class="primary--text "&gt;Smarters Booking Management&lt;/span&gt;&lt;/h1&gt;</p>',
                btntext: "Book Slot",
                btntext1: "Contact Us",
                btnlink: "/categories",
                btnlink1: "/contact-us",
            ...
            // partners: [],
            // partnerimages: [],
            aboutexcerpts: '<p>&lt;h1 class="text-h1 text-sm-h2"&gt;About us&lt;/h1&gt;</p>',
            showabout: 'false',
            whyusimage: '',
