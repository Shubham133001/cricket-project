<template>
  ...
  export default {
    ...
    methods: {
      ...
      async getAdmin() {
        await axios
          .get("/api/admin/getadminuser/" + this.$route.params.id)
          .then((response) => {
            this.fullname = response.data.records.name;
            this.email = response.data.records.email;
            this.group = response.data.records.admin_group_id;
      ...
      submit(e) {
        if (this.$refs.form.validate()) {
          ...
          axios
            .post("/api/admin/updateadminuser/"+this.$route.params.id, {
              name: this.fullname,
              email: this.email,
              password: this.password,
              admin_group_id: this.group,
              status: this.status,
            })
            .then((response) => {
